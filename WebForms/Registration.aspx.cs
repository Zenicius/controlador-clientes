...
public partial class Registration : System.Web.UI.Page
{
    ...
    {
        var cliente = new ServiceReference.Cliente();

        cliente.Id = clienteID;
        cliente.CPF = CPF.Text;
        cliente.Nome = Nome.Text;
        cliente.DataNascimento = Convert.ToDateTime(DataNascimento.Text);
        cliente.Sexo = ddSexo.SelectedValue;
        cliente.EstadoCivil = ddEstadoCivil.SelectedValue;

        cliente.RG = RG.Text;
        if (DataExpedicao.Text != "")
            cliente.DataExpedicao = Convert.ToDateTime(DataExpedicao.Text);
        else
            cliente.DataExpedicao = null;
        cliente.OrgaoExpedicao = ddOrgaos.SelectedValue;
        cliente.UFExpedicao = ddUFExpedicao.SelectedValue;
